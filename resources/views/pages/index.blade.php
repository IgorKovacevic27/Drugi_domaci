...
<head>
 ...
 <body style="background-color:#e8ebec;">
	...
	<div class="container">
        ...
        <img src="{{asset('/images/scania.jpeg')}}" alt="Slika se ne moze prikazati" width="600"/>
	...
	<div class="container" >
		<div class="row">
			<div class="col-md-8" id="podaci">
				<ul>
					<li><span class="glyphicon glyphicon-pushpin" ></span> Vojvode Supljikca 12</li>
					<li><span class="glyphicon glyphicon-earphone"></span> 011/122 120</li>
					<li><span class="glyphicon glyphicon-phone"></span> 060/11 11 111</li>
					<li><span class="glyphicon glyphicon-envelope"></span> rentatruck@yahoo.com</li>
